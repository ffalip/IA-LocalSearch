...
public class ProbLSSuccessorFunctionSA implements SuccessorFunction {
    ...
    public List getSuccessors(Object aState) { // retorna ArrayList on cada element es un sucessor
        ...
        pos_fitxer = myRandom.nextInt(pare.getActualBoard().get(id_user).length);
        ...
        String string_info = "Fitxer " + num_fitxer + " del usuari " + id_user + " passa del servidor " + pare.getActualBoard().get(id_user).get(pos_fitxer).getSecond() + " al servidor " + num_server;
